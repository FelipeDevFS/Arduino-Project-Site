const projetos = [
...

  {
    ...
    imgSrc: 'img/Projeto02Tinkercad.jpg',
    relatorio: {
        disciplina: 'Sistemas de Computação e de Informação',
        participantes: 'Arthur Vinicius Sena Campos, Gabriel Marcos Ferreira da Silva, Felipe Oliveira Carvalho, Juan Pablo Souza Chagas, Felipe Henrique dos Reis Martins, Hugo Mesquita Nunes, Danilo Claudino Carvalho',
        laboratorio: 'Sala C32',
...

{
  id: "exampleModal3",
  titulo: "Projeto 03",
  descricao: "Projeto de contro+-+-le de cores com LED RGB utilizando Arduino.",
  ...
  relatorio: {
    ...
    laboratorio: "Sala C32",
    dia: "18/09/2024",
    introducao: "Este projeto utilizou um LED RGB para explorar o controle de cores e a combinação de diferentes intensidades de luz para formar novas cores.",
...

{
  id: "exampleModal5",
  titulo: "Projeto 05",
  descricao: "Projeto para controle de cores de um LED RGB utilizando um sensor ultrassônico com Arduino.",
  ...
  relatorio: {
    ...
    laboratorio: "Sala C32",
    dia: "02/10/2024",
    introducao: "Neste projeto, utilizamos um sensor ultrassônico para controlar as cores de um LED RGB. A distância detectada pelo sensor define a cor exibida no LED, permitindo uma interação visual baseada na proximidade do objeto ao sensor.",
    objetivos: "⦁ Integrar um sensor ultrassônico e um LED RGB utilizando o Arduino. ⦁ Desenvolver um código que ajuste a cor do LED RGB com base na distância medida pelo sensor. ⦁ Testar e validar o sistema no Tinkercad antes da montagem física.",
    materiais: "⦁ Protoboard. ⦁ Fios Jumper. ⦁ Sensor Ultrassônico HC-SR04. ⦁ Arduino Uno. ⦁ LED RGB.",
    diagrama: "img/DiagramaModal5.jpg",
    codigo: "img/CodigoModal5.jpg",
    procedimentos: "⦁ Simulação no Tinkercad para testar o sensor ultrassônico e o LED RGB com o Arduino. ⦁ Programação do Arduino para ler a distância do sensor e definir a cor do LED RGB de acordo com essa leitura. ⦁ Montagem do circuito físico e upload do código no Arduino.",
...

{
  ...
  imgSrc: "img/projeto06-pushb.jfif",
  relatorio: {
    disciplina: "Sistemas de Computação e de Informação",
    ...
    diagrama: "img/DiagramaModal6.jpg",
    codigo: "img/CodigoModal6.jpg",
...

{
  ...
  imgSrc: "img/Projeto7Tinkercad.jpg",
  relatorio: {
    disciplina: "Sistemas de Computação e de Informação",
    participantes: "Felipe Oliveira Carvalho, Danilo Claudino Carvalho, Juan Pablo Souza Chagas, Felipe Henrique dos Reis Martins, Hugo Mesquita Nunes, Arthur Vinicius Sena Campos, Gabriel Marcos Ferreira da Silva",
    laboratorio: "Sala C32",
    ...
    diagrama: "img/DiagramaModal7.jpg",
    codigo: "img/codigoModal7.jpg",
...

{
  ...
  relatorio: {
    ...
    diagrama: "img/DiagramaModal8.jpg",
    codigo: "img/CodigoModal8.jpg",
